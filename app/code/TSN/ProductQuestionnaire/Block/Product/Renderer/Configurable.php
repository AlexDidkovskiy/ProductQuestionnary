...
namespace TSN\ProductQuestionnaire\Block\Product\Renderer;
...
class Configurable extends BaseConfigurable implements
    IdentityInterface
{
    /**
     * Path to template file with Swatch renderer.
     */
    const SWATCH_RENDERER_TEMPLATE = 'TSN_ProductQuestionnaire::product/view/swatches.phtml';
