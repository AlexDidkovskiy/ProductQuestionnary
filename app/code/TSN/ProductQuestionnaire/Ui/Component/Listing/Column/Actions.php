...
{
    const URL_PATH_EDIT   = 'questionnaire/question/edit';
    const URL_PATH_DELETE = 'questionnaire/question/delete';
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item[SchemaQuestionnaireInterface::ID_FIELD])) {
                    $item[$this->getData('name')] = [
                        'edit' => [
                            'href'  => $this->urlBuilder->getUrl(
                                static::URL_PATH_EDIT,
                                [
                                    SchemaQuestionnaireInterface::ID_FIELD => $item[SchemaQuestionnaireInterface::ID_FIELD]
                                ]
                            ),
                            'label' => __('Edit')
                        ],
